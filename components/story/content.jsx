...
export default props => {
  if (props.currentScene.type === "acquire") {
    props.acquireItem(props.currentScene.item);
  }
  return (
    <div className="story">
      {props.currentScene.headline && <h1>{props.currentScene.headline}</h1>}
      {props.currentScene.content && (
        <FormattedContent content={props.currentScene.content} />
      )}

      {props.currentScene.author && (
        <p className="author">&ndash; {props.currentScene.author}</p>
      )}

      {props.currentScene.type === "dialog" && (
        <Dialog
      ...
      {props.currentScene.type === "question" && (
        <Question
      ...
      {props.currentScene.type === "withItems" && (
        <WithItems
          currentScene={props.currentScene}
          items={props.items}
          setScene={props.setScene}
      ...
      {(props.currentScene.type === undefined ||
        props.currentScene.type === "acquire") && (
